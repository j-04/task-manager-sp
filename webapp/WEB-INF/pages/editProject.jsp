...
<form class="form ml-3 mt-3" action="/projects/editProject" method="GET">
    <div class="form-group">
        <label id="form" for="name">Name</label><br>
        <input id="form" type="text" name="name" placeholder="name" value="${project.name}">
    </div>
    <div class="form-group">
        <label id="form" for="description">Description</label><br>
        <input id="form" type="text" name="description" placeholder="description" value="${project.description}">
    </div>
    <div class="form-group">
